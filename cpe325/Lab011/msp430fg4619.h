...
#define DAC12_VECTOR        (14u * 2u) /* 0xFFDC DAC 12 */
#define DMA_VECTOR          (15u * 2u) /* 0xFFDE DMA */
#define BASICTIMER_VECTOR   (16u * 2u) /* 0xFFE0 Basic Timer / RTC */
#define PORT2_VECTOR        (17u * 2u) /* 0xFFE2 Port 2 */
#define USART1TX_VECTOR     (18u * 2u) /* 0xFFE4 USART 1 Transmit */
#define USART1RX_VECTOR     (19u * 2u) /* 0xFFE6 USART 1 Receive */
#define PORT1_VECTOR        (20u * 2u) /* 0xFFE8 Port 1 */
#define TIMERA1_VECTOR      (21u * 2u) /* 0xFFEA Timer A CC1-2, TA */
#define TIMERA0_VECTOR      (22u * 2u) /* 0xFFEC Timer A CC0 */
#define ADC12_VECTOR        (23u * 2u) /* 0xFFEE ADC */
#define USCIAB0TX_VECTOR    (24u * 2u) /* 0xFFF0 USCI A0/B0 Transmit */
#define USCIAB0RX_VECTOR    (25u * 2u) /* 0xFFF2 USCI A0/B0 Receive */
#define WDT_VECTOR          (26u * 2u) /* 0xFFF4 Watchdog Timer */
#define COMPARATORA_VECTOR  (27u * 2u) /* 0xFFF6 Comparator A */
#define TIMERB1_VECTOR      (28u * 2u) /* 0xFFF8 Timer B CC1-2, TB */
#define TIMERB0_VECTOR      (29u * 2u) /* 0xFFFA Timer B CC0 */
#define NMI_VECTOR          (30u * 2u) /* 0xFFFC Non-maskable */
#define RESET_VECTOR        (31u * 2u) /* 0xFFFE Reset [Highest Priority] */
