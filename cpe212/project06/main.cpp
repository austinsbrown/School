//
// main.cpp  2019 Spring CPE 212 - Project06 - Graphs and STL
//
	...
	{		
		switch (op)
		{
			...
			case 'd':	// Add directed edge to graph object
                ...
                {
                    cout << "Error: either source or destination vertex not found" << endl;
                }
				catch ( ... )
                {
